...
# XXX/ This file is extracted from custom-tf-pose,
# and is used by inference-engine and device code.
# Since custom-tf-pose is untyped, this file is also left untyped.
# This file is adapted to be compatible with the output of trt_pose.


class Pair:
    """
    Two `BodyPart`s combined to form an edge in the `Human`'s skeleton.
    """

    def __init__(self, idx1: int, idx2: int, part_idx1: int, part_idx2: int,
                 coord1: Tuple[float, float], coord2: Tuple[float, float],
                 score: float) -> None:
        self.idx1, self.idx2 = idx1, idx2
        self.part_idx1, self.part_idx2 = part_idx1, part_idx2
